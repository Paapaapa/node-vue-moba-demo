<template>
  <div>
    ...
    <div class="nav nav-inverse jc-around pb-1 bg-primary pt-3">
      <div class="nav-item active">
        <router-link class="nav-link" tag="div" to="/">首页</router-link>
      </div>
      <div class="nav-item">
        <router-link class="nav-link" tag="div" to="/1">攻略中心</router-link>
      </div>
      <div class="nav-item">
        <router-link class="nav-link" tag="div" to="/2">赛事中心</router-link>
      </div>
    </div>
